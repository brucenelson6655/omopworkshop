...
-- MAGIC %md
-- MAGIC # Create OMOP 5.3.1 Lakehouse Database
...
-- MAGIC %md
-- MAGIC #### delta_root_path='/dbfs/mnt/gwas-test/omop/delta/synthea/'
-- MAGIC #### databasePath=delta_root_path+'/silver/OMOP531'
-- MAGIC #### vocabPath='/dbfs/mnt/gwas-test/omopvocab/'
-- MAGIC #### synthea_path='/dbfs/mnt/gwas-test/synthea/100K'
...
-- DBTITLE 0,Use OMOP 5.3.1 Database
USE OMOP531;

-- COMMAND ----------

-- MAGIC %md
-- MAGIC ## OMOP 5.3.1 Tables
...
-- DBTITLE 0,Create OMOP 5.3.1 Tables
INSERT INTO
  metadata
VALUES
  (
...
-- MAGIC %md
-- MAGIC ## Create OMOP 5.3.1 Result Tables
